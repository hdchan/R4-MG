...
class Configuration_test(RandomTestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(sut.cache_dir_path, f'{pictures_location}/{sut.app_path_name}/cache/')
        self.assertEqual(sut.cache_preview_dir_path, f'{sut.cache_dir_path}preview/')
