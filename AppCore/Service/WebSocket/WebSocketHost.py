...
from .WebSocketServiceProtocol import WebSocketHostDelegate, WebSocketClientObjectProtocol, WebSocketMessageProtocol
...
class WebSocketHost(QObject):
    ...
    def on_new_connection(self):
        ...
        if self.delegate is not None:
            self.delegate.host_received_client_connection(WebSocketClientObject(client_socket))
