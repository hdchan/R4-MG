...
class CardResourceProvider:
    ...
    def _image_path(self) -> str:
        return f'{self._configuration_manager.configuration.cache_card_search_dir_path}{self._trading_card.image_source_domain}/'

    @property
    def _image_preview_dir(self) -> str:
        return f'{self._configuration_manager.configuration.cache_card_search_preview_dir_path}{self._trading_card.image_source_domain}/'
