...
DataSourceCardSearchClientSearchResult = Tuple[
    Optional[DataSourceCardSearchClientSearchResponse], Optional[Exception]]
DataSourceCardSearchClientSearchCallback = Callable[[
    DataSourceCardSearchClientSearchResult], None]
