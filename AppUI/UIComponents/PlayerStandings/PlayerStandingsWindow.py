...
from .PlayerStandingsViewController import PlayerStandingsViewController


class PlayerStandingsWindow(AppWindow):
    def __init__(self,
                 app_dependencies_provider: AppDependenciesInternalProviding):
        super().__init__(app_dependencies_provider=app_dependencies_provider, 
                         central_widget=PlayerStandingsViewController(app_dependencies_provider),
                         window_config_identifier="player_standings",
