...
class PlayerStandingsListSettingsViewController(SettingsContainerChildProtocol):
    ...
    def _setup_view(self):
        ...
        self._header_text_label = LineEditText(triggered_fn=self._mutable_app_ui_configuration.set_player_standings_header_text)
        self._standings_count_label = LineEditInt(triggered_fn=self._mutable_app_ui_configuration.set_player_standings_count)
            ...
            ScrollArea(
                VerticalBoxLayout([
                    ...
                    VerticalGroupBox([
                        ...
                        HorizontalLabeledInputRow("Header text", self._header_text_label),

                        HorizontalLabeledInputRow("Standings count", self._standings_count_label),
                    ]),
    ...
    def _sync_ui(self):
        self._header_text_label.set_value(self._mutable_app_ui_configuration.player_standings_header_text)
        self._standings_count_label.set_value(self._mutable_app_ui_configuration.player_standings_count)
    ...
    def will_apply_settings(self, mutable_app_ui_configuration: MutableAppUIConfiguration) -> MutableAppUIConfiguration:
        ...
        mutable_app_ui_configuration.set_player_standings_header_text(self._mutable_app_ui_configuration.player_standings_header_text)
        mutable_app_ui_configuration.set_player_standings_count(self._mutable_app_ui_configuration.player_standings_count)
