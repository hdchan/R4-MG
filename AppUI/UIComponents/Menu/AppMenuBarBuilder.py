...
class AppMenuBarBuilder:
    ...
    def build_image_deployment_menu_bar(self, window: QMainWindow) -> RMenuBarBuilder:
        ...
        def prompt_generate_new_file_with_placeholder(placeholder_image_path: Optional[str]):
            file_name, ok = self._router.prompt_text_input(
                'Create new image file', 'Enter file name:')
            if ok:
                try:
                    self._data_source_image_resource_deployer.generate_new_file(
                        file_name, placeholder_image_path)
        ...
        return RMenuBarBuilder([
            ...
            .add_separator()
            .add_actions([
                RActionMenuItem("New image file", lambda: prompt_generate_new_file_with_placeholder(
                    self._external_app_dependencies_provider.card_back_image_path)),
                RActionMenuItem(
                    "Refresh production images", self._data_source_image_resource_deployer.load_production_resources),
                RActionMenuItem(
                    "Unstage all staged resources", confirm_unstage_all_resources),
            ]),
            self.image_preview_view_toggle_menu()
            .add_separator()
            .add_actions([
                AppUIConfigurationCheckableRActionMenuItem(
                    ...
                    lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_hide_deployment_cell_controls(
                        not old_config.core_configuration.hide_deployment_cell_controls)
                ),
                AppUIConfigurationCheckableRActionMenuItem(
                    self._app_dependencies_provider,
                    "Horizontal deployment list",
                    lambda x: x.core_configuration.is_deployment_list_horizontal,
                    lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_is_deployment_list_horizontal(
                        not old_config.core_configuration.is_deployment_list_horizontal)
                ),
            ])
            .add_menus([
                ...
                .add_menus([
                    RMenuListBuilder("Criteria", [
                        AppUIConfigurationCheckableRActionMenuItem(
                            ...
                            lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_deployment_list_sort_criteria(
                        ...
                        AppUIConfigurationCheckableRActionMenuItem(
                            ...
                            lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_deployment_list_sort_criteria(
                                Configuration.Settings.DeploymentListSortCriteria.FILE_NAME)
                        ),
                    ]),
                    RMenuListBuilder("Order", [
                        AppUIConfigurationCheckableRActionMenuItem(
                            ...
                            lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_deployment_list_sort_order(
                                False)
                        ),
                        AppUIConfigurationCheckableRActionMenuItem(
                            self._app_dependencies_provider,
        ...
        return RMenuListBuilder("View") \
            .add_menus([
                RMenuListBuilder("Card title detail", [
                    AppUIConfigurationCheckableRActionMenuItem(
                        ...
                        lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_card_title_detail(
                            Configuration.Settings.CardTitleDetail.SHORT)
                    ),
                    AppUIConfigurationCheckableRActionMenuItem(
                        self._app_dependencies_provider,
                        "Normal",
                        ...
                        lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_card_title_detail(
                            Configuration.Settings.CardTitleDetail.NORMAL)
                    ),
                    AppUIConfigurationCheckableRActionMenuItem(
                        self._app_dependencies_provider,
                        "Detailed",
                        ...
                        lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_card_title_detail(
                            Configuration.Settings.CardTitleDetail.DETAILED)
                    ),
                ]),
            ]) \
            .add_actions([
                AppUIConfigurationCheckableRActionMenuItem(
                    ...
                    lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_hide_image_preview(
                        not old_config.core_configuration.hide_image_preview)
                ),
            ]) \
            .add_menus([
                RMenuListBuilder("Image preview scale", [
                    AppUIConfigurationCheckableRActionMenuItem(
                        ...
                        lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_image_preview_scale(
                            0.25)
                    ),
                    AppUIConfigurationCheckableRActionMenuItem(
                        self._app_dependencies_provider,
            ...
            .add_actions([
                AppUIConfigurationCheckableRActionMenuItem(
                    ...
                    lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_show_resource_details(
                        not old_config.core_configuration.show_resource_details)
                ),
            ]) \
    ...
    def toggles_menu(self) -> RMenuListBuilder:
        return RMenuListBuilder("Toggles", [
            AppUIConfigurationCheckableRActionMenuItem(
                ...
                lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_is_draft_list_image_preview_enabled(
                    not old_config.core_configuration.is_draft_list_image_preview_enabled)
            ),
        ])
    ...
    def windows_menu(self) -> RMenuListBuilder:
        return RMenuListBuilder("Windows",) \
            .add_actions([
                RActionMenuItem("Manage set list",
                                self._router.open_manage_deck_list_page),
            ]) \
            .add_separator() \
            .add_actions([
                RActionMenuItem("Draft list deployer",
                                self._router.open_draft_list_deployment_view),
                RActionMenuItem("Draft list image preview",
                                self._router.open_draft_list_image_preview_view),
                RActionMenuItem("Image deployer",
    ...
    def help_menu(self, initial_settings_tab_index: int = 0) -> RMenuListBuilder:
        return RMenuListBuilder("Help") \
            .add_actions([
                RActionMenuItem("Settings", lambda: self._router.open_app_settings_page(
                    initial_settings_tab_index)),
                RActionMenuItem(
                    "Quick guide", self._router.open_shortcuts_page),
            ]) \
            .add_separator() \
            .add_actions([

                RActionMenuItem("Check for updates",
                                self._router.open_update_page),
    ...
    def developer_menu(self) -> Optional[RMenuListBuilder]:
        ...
        result_menu = RMenuListBuilder("Developer", [
            AppUIConfigurationCheckableRActionMenuItem(
                ...
                lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_is_mock_data(
                    not old_config.core_configuration.is_mock_data)
            ),
            ...
            AppUIConfigurationCheckableRActionMenuItem(
                ...
                lambda mutable_config, old_config: mutable_config.core_mutable_configuration.set_is_delay_network_mode(
                    not old_config.core_configuration.is_delay_network_mode)
            ),
        ])

        modified_menu = self._external_app_dependencies_provider.hook_developer_menu(
            result_menu)
