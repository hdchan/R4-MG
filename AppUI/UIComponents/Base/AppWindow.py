...
class AppWindow(QMainWindow, TransmissionReceiverProtocol):
    ...
    def _load_window_size(self):
        ...
        config_result = self._app_ui_configuration_manager.configuration.window_size(self._window_config_identifier)
    ...
    def save(self):
        if self._window_size is not None:
            ...
            new_config.set_window_size(self._window_config_identifier, self._window_size[0], self._window_size[1])
