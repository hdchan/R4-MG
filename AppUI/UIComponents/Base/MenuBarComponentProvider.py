...
from PyQtUI import ActionMenuItem
...
class AppUIConfigurationCheckableActionMenuItem(QAction, TransmissionReceiverProtocol):
    def __init__(self,
                 app_dependencies_provider: AppDependenciesProviding, 
                 text: str,
...
class ConfigurationCheckableActionMenuItem(QAction, TransmissionReceiverProtocol):
    def __init__(self,
                 app_dependencies_provider: AppDependenciesProviding, 
                 text: str,
...
class MenuBarScreenWidgetProvider:
    ...
    # MARK: - actions
    def settings_action(self) -> ActionMenuItem:
        return ActionMenuItem("Settings", 
