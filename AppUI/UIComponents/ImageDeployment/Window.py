...
class Window(QMainWindow, TransmissionReceiverProtocol):
    def __init__(self,
        ...
        self.observation_tower = app_dependencies_provider.observation_tower
        ...
        main_program = MainProgramViewController(app_dependencies_provider)
        self.setCentralWidget(main_program)
