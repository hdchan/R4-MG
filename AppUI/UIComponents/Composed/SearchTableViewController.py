...
from AppCore.Models import CardType, SearchConfiguration
...
class SearchTableViewController(QWidget, TransmissionReceiverProtocol, DataSourceCardSearchDelegate, SearchTableComboViewControllerDelegate):
    def __init__(self, 
        ...
        ds_configuration = DataSourceCardSearch.DataSourceCardSearchConfiguration('search_history', 40)
        self._card_search_data_source = app_dependency_provider.new_instance_card_search_data_source(delegate=self,  
                                                                                                     search_client_provider=app_dependency_provider.search_client_provider, 
        ...
        app_dependency_provider.shortcut_action_coordinator.bind_flip(self._flip_card, self)
        app_dependency_provider.shortcut_action_coordinator.bind_focus_search(self._search_table_combo_view.set_search_focus, self)
        app_dependency_provider.shortcut_action_coordinator.bind_reset_search(self._search_table_combo_view.reset_search, self)
        app_dependency_provider.shortcut_action_coordinator.bind_search(self._search, self)
    ...
    def ds_did_retrieve_card_resource_for_card_selection(self, 
                                                         ds: DataSourceCardSearch):
        if self._card_search_data_source.current_card_search_resource is not None:
            self._image_preview_view.set_image(self._card_search_data_source.current_card_search_resource)
        self._search_table_combo_view.sync_ui()
